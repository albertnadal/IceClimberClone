...
EPAMinkowskiPenetrationSolver.o: third_party/collision/algorithm/EPAMinkowskiPenetrationSolver.cpp
	$(CXX) -c $(CFLAGS) third_party/collision/algorithm/EPAMinkowskiPenetrationSolver.cpp
