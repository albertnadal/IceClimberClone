...
enum SoundIdentificator: uint16_t { JUMP_SOUND = 0, BREAK_BLOCK_SOUND = 1, HIT_ENEMY_SOUND = 2, HIT_NITPICKER_SOUND = 3, TAKE_VEGETABLE_SOUND = 4, GAME_OVER_SOUND = 5, LOSE_LIFE_SOUND = 6, MAX_SOUND_IDENTIFICATORS };
