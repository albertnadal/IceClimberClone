...
enum BonusStageTileAAnimation: uint16_t { BONUS_STAGE_TILE_A_STICKY = 71 };
enum BonusStageTileBAnimation: uint16_t { BONUS_STAGE_TILE_B_STICKY = 72 };
enum BonusStageTileCAnimation: uint16_t { BONUS_STAGE_TILE_C_STICKY = 73 };
enum EggplantAnimation: uint16_t { EGGPLANT_STICKY = 74 };
enum CarrotAnimation: uint16_t { CARROT_STICKY = 75 };
enum CabbageAnimation: uint16_t { CABBAGE_STICKY = 76 };
enum ZucchiniAnimation: uint16_t { ZUCCHINI_STICKY = 77 };
enum CornAnimation: uint16_t { CORN_STICKY = 78 };
enum TurnipAnimation: uint16_t { TURNIP_STICKY = 79 };
enum PumpkinAnimation: uint16_t { PUMPKIN_STICKY = 80 };
enum RomaineLettuceAnimation: uint16_t { ROMAINE_LETTUCE_STICKY = 81 };
enum PotatoAnimation: uint16_t { POTATO_STICKY = 82 };
enum MushroomAnimation: uint16_t { MUSHROOM_STICKY = 83 };
enum OneAnimation: uint16_t { ONE_STICKY = 84 };
enum TwoAnimation: uint16_t { TWO_STICKY = 85 };
enum ThreeAnimation: uint16_t { THREE_STICKY = 86 };
enum FourAnimation: uint16_t { FOUR_STICKY = 87 };
enum FiveAnimation: uint16_t { FIVE_STICKY = 88 };
