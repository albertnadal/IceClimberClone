...
constexpr char* WINDOW_TITLE = "Ice Climber clone (alpha version)";              // Title to show in the application window bar.
constexpr char* ENTITIES_DATA_FILENAME = "entities.dat";                         // The data file where entity animations and collision areas are defined.
...
constexpr char* AUDIO_FOLDER = "audio/";                                         // The folder where audio files are located.
constexpr char* MAIN_MENU_MUSIC_FILENAME = "title_screen.mp3";                   // Background music for the title screen menu.
constexpr char* GAME_PLAY_MUSIC_FILENAME = "stage_theme.mp3";                    // Background music for the mountain game play.
constexpr char* STAGE_CLEAR_MUSIC_FILENAME = "stage_clear.mp3";                  // Background music for the stage score summary screen.
