...
constexpr const char *MOUNTAIN_FILENAME = "levels/mountain?.dat";                // The data file where mountain information is stored.
constexpr const char *AUDIO_FOLDER = "audio/";                                   // The folder where audio files are located.
constexpr const char *MAIN_MENU_MUSIC_FILENAME = "title_screen.mp3";             // Background music for the title screen menu.
constexpr const char *GAME_PLAY_MUSIC_FILENAME = "stage_theme.mp3";              // Background music for the mountain game play.
constexpr const char *STAGE_CLEAR_MUSIC_FILENAME = "stage_clear.mp3";            // Background music for the stage score summary screen.
